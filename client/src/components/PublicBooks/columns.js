...
export const columns = (sortedInfo, filteredInfo, tags, language) => {
    return [
        ...
        },
        {
            ...
            key: 'avarageRating',
            sorter: (a, b) => a.avarageRating - b.avarageRating,
            sortOrder: sortedInfo.columnKey === 'avarageRating' && sortedInfo.order,
        ...
        {
            title: language === "ru" ? "Автор" : "Author",
            dataIndex: "author",
            key: "author",
            render: (author) => {
                if (author) {
                    return (
                        <>
                            <td className="ant-table-cell ant-table-cell-ellipsis"> {author?.login}</td>
                        </>
                    )
                }
            }
